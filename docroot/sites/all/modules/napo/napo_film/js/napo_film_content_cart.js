        ...
        attach: function (context, settings) {
            ...
            $('input.napo_film_select_in_cart', context).once('napo_film_select_in_cart_toggle', function () {
                ...
                if (typeof id != 'undefined') {
                    var ajax_settings = {};
                    ajax_settings.url = Drupal.settings.basePath + Drupal.settings.pathPrefix + 'napo_film/ajax/select_in_cart/' + id;
...
(function($) {
    $.fn.napo_film_refresh_download_center = function() {
        ...
        var ajax_settings = {};
        ajax_settings.url = Drupal.settings.basePath + Drupal.settings.pathPrefix + 'content_cart/ajax/submit/none/none/download_center-page';
